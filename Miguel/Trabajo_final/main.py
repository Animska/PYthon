...
from api.schemas import LoginRequest, LoginResponse, RegisterPatientRequest, PatientProfileResponse, UpdateProfileRequest, RegisterDoctorRequest, DoctorResponse, AppointmentCreate, AppointmentUpdate
from api.repository import authenticate_user, create_patient, get_patient_profile, update_patient_profile, get_all_doctors, create_doctor, create_appointment, get_pending_appointments, update_appointment_status, get_all_appointments
